package www.ssitinfotech.com.uploadimage;
 ...
 */
public class AHActivityWithAr extends Activity {
    float[] aValues = new float[3];
    float[] mValues = new float[3];
    HorizonViewB horizonView;
    ...
    public void onCreate(Bundle icicle) {
        ...
        setContentView(R.layout.main_with_ar);
        inPreview = false;
        ...
        horizonView = (HorizonViewB)this.findViewById(R.id.horizonView);
